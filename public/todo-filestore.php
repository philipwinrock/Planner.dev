...
if (count($_FILES) > 0 && $_FILES['file1']['error'] == 0) {
    ...
    $arrayFromNewObject = $newListObject->read_lines();
...
<form method="POST" enctype="multipart/form-data" action="/todo-filestore.php">
        
    <p> <label for="file1">File to upload:      </label>
...
<form method="POST" action="/todo-filestore.php">
    <p>
